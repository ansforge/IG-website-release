# Modèle logique métier - FR LM Facteurs de risque professionnels non code - ANS IG document core v0.1.0-snapshot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-facteurs-de-risque-professionnels-non-code | *Version*:0.1.0-snapshot |
| Draft as of 2026-04-15 | *Computable Name*:FRLMFacteursDeRisqueProfessionnelsNonCode |
