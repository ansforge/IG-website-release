# Mapping FRLMResultatsEntry → FRCDAResultats → FRDiagnosticReportDocument - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/ConceptMap/FRDiagnosticReportLMCDAFHIR | *Version*:0.1.0-snapsnot |
