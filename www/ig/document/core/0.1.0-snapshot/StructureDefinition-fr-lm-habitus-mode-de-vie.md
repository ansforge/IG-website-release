...
| Draft as of 2026-04-07 | *Computable Name*:FRLMHabitusModeDeVie |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-habitus-mode-de-vie-entree"
      }]
    }]
  }
}
