# Modèle logique métier - FR LM Vaccin recommandé - ANS IG document core v0.1.0-snapshot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-vaccin-recommande | *Version*:0.1.0-snapshot |
