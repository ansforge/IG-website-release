...
| Draft as of 2026-03-13 | *Computable Name*:FRLMAntecedentsMedicaux |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.document.fr.core|current/StructureDefinition/fr-lm-antecedents-medicaux)
