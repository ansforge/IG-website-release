...
| Active as of 2026-03-13 | *Computable Name*:NdE_EventType |
...
* Utilise ce/t/te Extension: [NdE_EventDeclarationNdE](StructureDefinition-nde-eventdeclaration.md), [NdE_NotificationRequestNdE](StructureDefinition-nde-notificationrequest.md) and [NdE_SubscriptionNdE](StructureDefinition-nde-subscription.md)
* Exemples pour ce/t/te Extension: [CommunicationRequest/com1](CommunicationRequest-com1.md), [CommunicationRequest/com2](CommunicationRequest-com2.md) and [Subscription/sub1](Subscription-sub1.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.nde|current/StructureDefinition/event-type)
...
```json
{
  ...
  "title" : "Event Type",
  "status" : "active",
  "date" : "2026-03-13T16:32:11+00:00",
