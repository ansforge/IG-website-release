...
| Draft as of 2026-02-09 | *Computable Name*:NdE_EventDeclarationNdE |
...
* Exemples pour ce/t/te Profil: [CommunicationRequest/com2](CommunicationRequest-com2.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.nde|current/StructureDefinition/nde-eventdeclaration)
