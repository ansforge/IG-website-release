...
| Active as of 2026-03-13 | *Computable Name*:NdE_NotificationRequestNdE |
...
* Exemples pour ce/t/te Profil: [CommunicationRequest/com1](CommunicationRequest-com1.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.nde|current/StructureDefinition/nde-notificationrequest)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/nde/StructureDefinition/event-emission-time"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://interop.esante.gouv.fr/ig/fhir/nde/StructureDefinition/nde-subscription"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/nde/StructureDefinition/recipient-endpoint"]
      }]
    }]
  }
}
