...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Consent/f:provision/f:data/f:reference</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Consent/f:provision/f:data/f:reference/f:identifier</sch:title>
    <sch:rule context="f:Consent/f:provision/f:data/f:reference/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
