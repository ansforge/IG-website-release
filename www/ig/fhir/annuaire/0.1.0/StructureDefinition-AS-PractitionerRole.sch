...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PractitionerRole">
      ...
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/PractitionerRole-EducationLevel']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/PractitionerRole-EducationLevel': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/PractitionerRole-SmartCard']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/PractitionerRole-SmartCard': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/PractitionerRole-PartOf']) &lt;= 0">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/PractitionerRole-PartOf': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/MailboxMSS']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/MailboxMSS': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PractitionerRole/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'description']) &lt;= 0">extension with URL = 'description': maximum cardinality of 'extension' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PractitionerRole/f:extension/f:extension/f:value[x]/f:coding 1</sch:title>
    <sch:rule context="f:PractitionerRole/f:extension/f:extension/f:value[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
