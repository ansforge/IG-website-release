...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner">
      ...
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Practitioner-Nationality']) &lt;= 0">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Practitioner-Nationality': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Practitioner-BirthPlace']) &lt;= 0">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Practitioner-BirthPlace': maximum cardinality of 'extension' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Practitioner/f:extension/f:extension/f:value[x]/f:coding 1</sch:title>
    <sch:rule context="f:Practitioner/f:extension/f:extension/f:value[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
