...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:HealthcareService">
      ...
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-ActivityType']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-ActivityType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-AuthorizationDate']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-AuthorizationDate': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-AuthorizationNumberARHGOS']) &gt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-AuthorizationNumberARHGOS': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-AuthorizationNumberARHGOS']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-AuthorizationNumberARHGOS': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-ImplementationPeriod']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-ImplementationPeriod': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-DeleteAutorisationImplantation']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-DeleteAutorisationImplantation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-DateUpdateActivity']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/HealthcareService-DateUpdateActivity': maximum cardinality of 'extension' is 1</sch:assert>
