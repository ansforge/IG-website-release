...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Device">
      ...
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Device-NumberAuthorizationARHGOS']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Device-NumberAuthorizationARHGOS': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Device-AuthorizationDateDevice']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Device-AuthorizationDateDevice': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Device-PeriodImplentation']) &lt;= 1">extension with URL = 'https://annuaire.sante.gouv.fr/fhir/StructureDefinition/Device-PeriodImplentation': maximum cardinality of 'extension' is 1</sch:assert>
