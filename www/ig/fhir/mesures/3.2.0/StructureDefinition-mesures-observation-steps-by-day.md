# Nombre de pas par jour - Guide d'implémentation FHIR - Mesures de santé v3.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-observation-steps-by-day | *Version*:3.2.0 |
| Active as of 2026-02-18 | *Computable Name*:MesObservationStepsByDay |
...
* Exemples pour ce/t/te Profil: [Observation/example-mes-fr-observation-steps-by-day-001](Observation-example-mes-fr-observation-steps-by-day-001.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.mesures|current/StructureDefinition/mesures-observation-steps-by-day)
