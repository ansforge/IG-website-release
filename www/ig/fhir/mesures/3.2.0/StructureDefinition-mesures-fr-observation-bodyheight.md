# Taille - Guide d'implémentation FHIR - Mesures de santé v3.2.0
...
| Active as of 2026-02-18 | *Computable Name*:MesFrObservationBodyHeight |
...
* Exemples pour ce/t/te Profil: [Observation/example-mes-fr-observation-body-height-001](Observation-example-mes-fr-observation-body-height-001.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.mesures|current/StructureDefinition/mesures-fr-observation-bodyheight)
...
```json
{
  ...
  "title" : "Taille",
  "status" : "active",
  "date" : "2026-02-18T13:40:11+00:00",
  "publisher" : "ANS",
  "contact" : [
    {
      "name" : "ANS",
