# Périmètre Crânien - Guide d'implémentation FHIR - Mesures de santé v3.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/mesures/StructureDefinition/mesures-observation-head-circumference | *Version*:3.2.0 |
| Active as of 2026-02-18 | *Computable Name*:MesObservationHeadCircumference |
...
* Exemples pour ce/t/te Profil: [Observation/example-mes-fr-observation-head-circumference-001](Observation-example-mes-fr-observation-head-circumference-001.md)

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.mesures|current/StructureDefinition/mesures-observation-head-circumference)
