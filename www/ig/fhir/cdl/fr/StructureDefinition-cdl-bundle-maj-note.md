...
## Profil de ressource: Bundle de mise à jour d'une note 

 
Profil du bundle pour le flux 2 de mise à jour d'une note du volet CdL 

**Utilisations:**

* Ce Profil n'est utilisé par aucun autre profil dans ce guide d'implémentation

Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.cdl|current/StructureDefinition/cdl-bundle-maj-note)
...
Autres représentations du profil : [CSV](../StructureDefinition-cdl-bundle-maj-note.csv), [Excel](../StructureDefinition-cdl-bundle-maj-note.xlsx), [Schematron](../StructureDefinition-cdl-bundle-maj-note.sch) 
