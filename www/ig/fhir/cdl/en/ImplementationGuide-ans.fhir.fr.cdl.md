...
```json
{
  ...
  "id" : "ans.fhir.fr.cdl",
  "language" : "fr",
  "url" : "https://interop.esante.gouv.fr/ig/fhir/cdl/ImplementationGuide/ans.fhir.fr.cdl",
  "version" : "3.0.1",
  "name" : "CDL",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://interop.esante.gouv.fr/ig/fhir/cdl/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "name" : "0d920958-b596-4b91-af67-9bafc707820b",
      "exampleBoolean" : true
    },
    {
      "extension" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/cdl-bundle-creation-note"
      },
      "name" : "Bundle de création d'une note",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/cdl-bundle-maj-note"
      },
      "name" : "Bundle de mise à jour d'une note",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/cdl-bundle-resultat-recherche-notes"
      },
      "name" : "Bundle résultat recherche notes",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Bundle/cdl-bundle-creation-note"
      },
      "name" : "cdl-bundle-creation-note",
      "exampleCanonical" : "https://interop.esante.gouv.fr/ig/fhir/cdl/StructureDefinition/cdl-bundle-creation-note|3.0.1"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "StructureDefinition/cdl-ext-is-emergency"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/ConsommateurContenu"
      },
      "name" : "CI-SIS Cahier-de-Liaison - ConsommateurContenu",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/CreateurContenu"
      },
      "name" : "CI-SIS Cahier-de-Liaison - CreateurContenu",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/GestionnaireCdL"
      },
      "name" : "CI-SIS Cahier-de-Liaison - GestionnaireCdL",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/cdl-document-reference"
      },
      "name" : "DocumentReference Cahier de Liaison",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ConceptMap/ConceptMap-mos-cdl"
      },
      "name" : "MOS to FHIR CDL",
    ...
    "page" : {
      ...
      },
      {
        ...
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "creation_note.html"
          }],
          "nameUrl" : "creation_note.html",
        ...
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "maj_note.html"
          }],
          "nameUrl" : "maj_note.html",
          "title" : "M-à-j d'une note",
          "generation" : "markdown"
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "suppr_note.html"
          }],
          "nameUrl" : "suppr_note.html",
        ...
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "recherche_note.html"
          }],
          "nameUrl" : "recherche_note.html",
